...
class EAuth extends CApplicationComponent {
	...
	/**
	 * @var string popup redirect views with custom js code
	 */
	...
	/**
	 * Change default redirect views to custom. Allow Yii alias.
	 * @param string $view new name of views with js code
	 */
